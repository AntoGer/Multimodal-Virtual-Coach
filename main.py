...
if __name__ == "__main__": 
    ...
    button1 = customtkinter.CTkButton(master=root, text="Squat", command=manager.ex_squat)
    button1.place(relx=0.5, rely=0.3, anchor=CENTER)

    # Creazione dei bottoni per le azioni
    button2 = customtkinter.CTkButton(master=root, text="Wallsit", command=manager.ex_wallsit)
    button2.place(relx=0.5, rely=0.4, anchor=CENTER)

    # Creazione dei bottoni per le azioni
    button3 = customtkinter.CTkButton(master=root, text="Workout", command=manager.ex_workout)
    button3.place(relx=0.5, rely=0.5, anchor=CENTER)

    # Bottone per uscire dal programma
    # Creazione dei bottoni per le azioni
    button_exit = customtkinter.CTkButton(master=root, text="Esci", command=manager.esci)
